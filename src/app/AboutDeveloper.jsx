    ...
    <Container className={classes.container}>
      <AppBar>
        <Toolbar>
          ...
          <Typography variant='h6'>关于开发者</Typography>
        </Toolbar>
      </AppBar>
      <Toolbar />
      <Paper className={classes.company}>
        <Typography>锤子科技</Typography>
        <Typography variant='caption' color='textSecondary'>没图，不做了。apk包里全是.9图，这个logo不做了</Typography>
      </Paper>
      <Paper className={classes.stack}>
        <List
          ...
          <ListItem>
            <ListItemIcon>
              <Avatar src='https://cordova.apache.org/static/img/cordova_bot.png' />
            </ListItemIcon>
            <ListItemText
              primary=<Link href='https://cordova.apache.org/'>Cordova</Link>
              secondary='Mobile apps with HTML, CSS & JS. Target multiple platforms with one code base. Free and open source'
            />
          </ListItem>
          <ListItem>
            <ListItemIcon>
